  ...
  return (
    <StyledTooltip content={t(tooltipKey)} placement="top">
      <span
        ...
        data-testid={testId}
        className={cn(
          "inline-flex size-7 shrink-0 items-center justify-center rounded-full bg-surface-raised text-content transition-colors hover:bg-[var(--oh-interactive-hover)]",
          className,
        )}
      >
        ...
        className={cn(
          ...
          isSelected &&
            (showRemoveIcon
              ...
              : "border border-[#3D3929] bg-transparent text-content [&_path]:fill-current"),
          !isSelected &&
            "border-0 bg-surface-raised text-content hover:bg-[var(--oh-interactive-hover)]",
