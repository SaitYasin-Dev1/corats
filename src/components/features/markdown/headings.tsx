...
export function h1({
  ...
  ExtraProps) {
  return (
    <h1 className="text-xl text-content-2 font-medium leading-7 mb-3 mt-4 first:mt-0">
      {children}
    </h1>
  );
}
...
export function h2({
  ...
  ExtraProps) {
  return (
    <h2 className="text-lg font-medium leading-6 -tracking-[0.01em] text-content-2 mb-2.5 mt-4 first:mt-0">
      {children}
    </h2>
  );
}
...
export function h3({
  ...
  ExtraProps) {
  return (
    <h3 className="text-base font-medium text-content-2 mb-2 mt-3 first:mt-0">
      {children}
    </h3>
  );
}
...
export function h4({
  ...
  ExtraProps) {
  return (
    <h4 className="text-sm font-medium text-content-2 mb-1.5 mt-3 first:mt-0">
      {children}
    </h4>
  );
}
