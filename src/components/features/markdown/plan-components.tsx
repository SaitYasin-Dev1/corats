...
export function createPlanComponents(extraClassName?: string) {
  return {
    h1: ({ children, className }: ElementProps) => (
      <h1
        className={cn(
          "text-lg text-content-2 font-bold leading-6 mb-1.5 mt-3 first:mt-0",
          className,
          extraClassName,
        )}
      >
    ...
    h2: ({ children, className }: ElementProps) => (
      <h2
        className={cn(
          "text-base font-semibold leading-5 text-content-2 mb-1 mt-2.5 first:mt-0",
          className,
          extraClassName,
        )}
      >
    ...
    h3: ({ children, className }: ElementProps) => (
      <h3
        className={cn(
          "text-sm font-semibold text-content-2 mb-1 mt-2 first:mt-0",
          className,
          extraClassName,
        )}
      >
    ...
    h5: ({ children, className }: ElementProps) => (
      <h5
        className={cn(
          "text-xs font-semibold text-content-2 mb-0.5 mt-1.5 first:mt-0",
          className,
          extraClassName,
        )}
      >
