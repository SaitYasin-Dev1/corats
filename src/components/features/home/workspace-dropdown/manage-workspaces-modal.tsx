                ...
                {staticWorkspaces.map((workspace) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-1 rounded text-xs text-[var(--oh-text-tertiary)] hover:bg-[var(--oh-interactive-hover)] hover:text-content cursor-pointer"
                    >
