          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex items-center gap-2 px-4 py-2 border-b border-[var(--oh-border-input)]">
              <button
                ...
                className="p-1 rounded hover:bg-[var(--oh-interactive-hover)] text-content disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
              >
              ...
              {subdirs.map((entry) => (
                <li key={entry.path}>
                  <button
                    ...
                    className="grid grid-cols-[1fr_120px] items-center w-full text-left px-4 py-1.5 text-sm text-content hover:bg-[var(--oh-interactive-hover)] cursor-pointer"
