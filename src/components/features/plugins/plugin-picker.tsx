    ...
    <div data-testid="plugin-picker" className="flex w-full flex-col gap-3">
      <div
        className={cn(
          ...
          "transition-colors focus-within:border-[#3D3929]/40 focus-within:ring-1 focus-within:ring-[#3D3929]/20",
        )}
      >
        <Search
        ...
        {search ? (
          <button
            ...
            className="mr-2 cursor-pointer rounded p-1 text-tertiary-alt hover:text-content"
          >
