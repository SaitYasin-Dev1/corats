  ...
  return (
    <code
      className={cn(
        ...
        "bg-[var(--oh-surface-raised)] px-1.5 py-0.5 align-baseline font-mono text-[11px] text-content",
      )}
    >
      {children}
    </code>
    ...
    <div className="relative">
      <pre
        ...
        className={cn(
          ...
          "bg-[var(--oh-surface-raised)] p-2 pr-10 text-xs text-content",
        )}
      >
        {ADD_SKILL_EXAMPLE_COMMAND}
      </pre>
      <button
        ...
        className={cn(
          ...
          "hover:bg-[var(--oh-surface)] hover:text-content disabled:cursor-default [&_path]:fill-current",
        )}
      >
        {copied ? (
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-6 custom-scrollbar">
          ...
          <a
            ...
            className="self-start text-xs text-[var(--oh-muted)] transition-colors hover:text-content hover:underline"
          >
