      ...
      <div className={cn(isDragging && "opacity-0")}>
        <div
          className={cn(
            ...
            "text-[var(--oh-muted)] transition-colors hover:bg-[var(--oh-surface-raised)] hover:text-content",
          )}
        >
          <button
            type="button"
          ...
          <button
            ...
            className={cn(
              ...
              "hover:bg-[#3D3929]/10 hover:text-content",
            ...
            {isPreviewTruncated ? (
              <div className="pl-2">
                <button
                  ...
                  className="cursor-pointer text-xs text-[var(--oh-text-dim)] hover:text-content"
                >
                  {isShowingAll
