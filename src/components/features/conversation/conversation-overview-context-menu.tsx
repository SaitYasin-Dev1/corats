...
function OverviewPinButton({
  ...
  return (
    <button
      ...
      data-testid={testId}
      className={cn(
        "flex shrink-0 cursor-pointer items-center justify-center rounded-r px-2 text-content",
        dropdownInstantColorClassName,
        "hover:bg-[#3D3929]/10",
      )}
      aria-pressed={pinned}
        ...
        >
          {isActionable ? (
            <button
              ...
              className={cn(
                "flex min-w-0 flex-1 cursor-pointer items-center gap-2 rounded-l p-2 text-start text-content",
                dropdownInstantColorClassName,
              )}
              onClick={onOpen}
            >
            ...
            <div
              data-testid={testIdOpen}
              className={cn(
                "flex min-w-0 flex-1 items-center gap-2 rounded-l p-2 text-start text-content",
                dropdownInstantColorClassName,
              )}
            >
              {labelContent}
