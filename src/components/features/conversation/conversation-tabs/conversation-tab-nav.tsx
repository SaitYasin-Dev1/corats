...
export function ConversationTabNav({
  ...
  const buttonClassName = cn(
    ...
    isActive && "bg-[var(--oh-interactive-active)] text-content",
    isActive
      ? "hover:text-content hover:bg-[var(--oh-interactive-hover)]"
      : "hover:text-content hover:bg-[#3D3929]/5",
    isActive
      ? "focus-within:text-content"
