    ...
    >
      ...
      >
        ...
        <fieldset className="flex w-full flex-col gap-2">
          ...
          <label className="flex cursor-pointer items-center gap-3 rounded-md border border-[var(--oh-border)] px-3 py-2 text-sm text-content">
            <input
              type="radio"
        ...
        <div className="flex w-full flex-col gap-3 text-sm text-content">
