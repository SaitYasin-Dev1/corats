  ...
  return (
    ...
    >
      <div
        ...
        className="max-h-40 overflow-y-auto px-4 py-3 text-content custom-scrollbar-always [--oh-scroll-fade-from:var(--oh-surface)]"
      >
      ...
      <div className="flex h-10 items-center justify-between gap-2 border-t border-[var(--oh-border)] px-3">
        ...
        {onView ? (
          ...
          >
            <Typography.Text className="text-[11px] leading-4 tracking-[0.11px] text-content">
              {t(I18nKey.COMMON$VIEW)}
            </Typography.Text>
            <ArrowUpRight className="text-content" size={16} />
          </button>
        ) : null}
      </div>
    </div>
