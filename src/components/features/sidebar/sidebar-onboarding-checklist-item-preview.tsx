...
const PREVIEW_ACTION_BUTTON_CLASS = cn(
  "inline-flex shrink-0 items-center rounded-md bg-[#1F1D17] px-2.5 py-1",
  "text-xs font-medium text-white transition-colors hover:bg-[#1F1D17]/90",
);
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3">
        <a
          ...
          className="inline-flex min-w-0 items-center gap-2 text-xs text-[var(--oh-muted)] transition-colors hover:text-content hover:underline"
          onClick={onDocsClick}
        >
